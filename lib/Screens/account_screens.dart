...
class accountScreen extends StatefulWidget {
  ...
  @override
  State<accountScreen> createState() => _UserReviewScreenState();
}

class _UserReviewScreenState extends State<accountScreen> {
  ...
  Future<void> saveProductToDb(CategoryProvider provider, context) async {
    try {
      await _service.products.add(provider.datasToFirestore).then((value) {
        provider.clearData();
        ScaffoldMessenger.of(context).showSnackBar(
          const SnackBar(
              content: Text(
